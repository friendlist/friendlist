...
<html lang="en">
  ...
  <div id="content">
    ...
    <script src="<?php echo $this->Html->url('/js/jquery.backstretch.min.js'); ?>"></script>
...
<script type="text/javascript">
	$.backstretch("http://www.total-manga.com/images/Wallpaper/FR-8-23926-B/yoshi-s-playground.jpg", {speed: 150});
</script>
